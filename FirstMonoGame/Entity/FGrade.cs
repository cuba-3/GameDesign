...
namespace FirstMonoGame.Entity
{
    class FGrade : IEntity
    {
        ...
        public FGrade(ContentManager content, GraphicsDevice graphicsDevice)
        {
            Sprite = (ItemSprite)FGradeSpriteFactory.Instance.FactoryMethod(content, graphicsDevice);
            isConsumed = false;
        }
