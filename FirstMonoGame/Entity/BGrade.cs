...
namespace FirstMonoGame.Entity
{
    class BGrade : IEntity
    {
        ...
        public BGrade(ContentManager content, GraphicsDevice graphicsDevice)
        {
            Sprite = (ItemSprite)BGradeSpriteFactory.Instance.FactoryMethod(content, graphicsDevice);
            isConsumed = false;
        }
