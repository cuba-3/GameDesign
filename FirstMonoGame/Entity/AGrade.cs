...
namespace FirstMonoGame.Entity
{
    class AGrade : IEntity
    {
        ...
        public AGrade(ContentManager content, GraphicsDevice graphicsDevice)
        {
            Sprite = (ItemSprite)AGradeSpriteFactory.Instance.FactoryMethod(content, graphicsDevice);
            isConsumed = false;
        }
