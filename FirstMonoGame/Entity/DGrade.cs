...
namespace FirstMonoGame.Entity
{
    class DGrade : IEntity
    {
        ...
        public DGrade(ContentManager content, GraphicsDevice graphicsDevice)
        {
            Sprite = (ItemSprite)DGradeSpriteFactory.Instance.FactoryMethod(content, graphicsDevice);
            isConsumed = false;
        }
